...
public class RegistrationSteps {
	...
	@When("the user enters the existing details into below fields")
	public void the_user_enters_the_existing_details_into_below_fields(io.cucumber.datatable.DataTable dataTable) {
	...
	@Then("the user account should get error message successfully")
	public void the_user_account_should_get_error_message_successfully() {
		String confmsg=regpage.getErrMsg();
